...
const EditContactsModal = (props: any) => {
  console.log("EditContactsModal props::::: ", props);
  ...
  React.useEffect(() => {
    ...
    if (val.data.id !== undefined && val.data.id) {
      fetchDetails(val.data.id);
    }
  ...
  const fetchDetails = (id: any) => {
    setLoading(true);
    setLoaded(false);
    HttpService.get("referral/contacts/detail/" + id)
      .then(
        (result) => {
          console.log(result);
          let res = result.data;
  ...
  console.log("Edit Contact renders");
  ...
  const handleSubmit = (e: any) => {
    ...
    HttpService.postHeader("referral/contacts/edit-contact", form)
      .then(
        (result) => {
          console.log(result);
          setResponse(result);
                    ...
                    <div className="flex flex-row justify-content-center align-items-center px20 py10">
                      ...
                      <div className="spacer text-right">
                        {tabIndex === 0 ? (
                          ...
                          <>
                            <Button onClick={pushRow}>LAUNCH PHONE BOOK</Button>
                          </>
                        ) : null}
                      </div>
                    </div>
...
export default React.memo(EditContactsModal);
