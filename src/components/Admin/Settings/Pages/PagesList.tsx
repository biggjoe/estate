...
export default function PagesList() {
  ...
  const togEdit = (i: any) => {
    if (i === "home") {
      return navigate(`/admin/settings/pages/edit-home`);
    }
        ...
        <div className="container py30">
          ...
          <Card sx={{ borderRadius: "0" }}>
              ...
              secondaryAction={
                <>
                  <Tooltip title="Edit Page">
                    <IconButton onClick={() => togEdit("home")}>
                      <Edit />
                    </IconButton>
                  </Tooltip>
                  <Tooltip title="Preview Page">
                    <IconButton onClick={() => launchPreview("home")}>
                      <Search />
                    </IconButton>
                  </Tooltip>
                </>
            ...
            >
              <ListItemButton>
                <ListItemText
                  primary={<h4 style={{ lineHeight: "1.2" }}>Home Page</h4>}
                ></ListItemText>
              </ListItemButton>
            </ListItem> */}
