...
const AdminHeader = (props: any) => {
  ...
  const pages: any[] = [
    ...
    { path: "deals", component: "Deals", icon: <AdUnitsOutlined /> }, */,
    { path: "users", component: "Users", icon: <AccountCircleOutlined /> },
    { path: "settings", component: "Site Settings", icon: <Settings /> },
  ];
